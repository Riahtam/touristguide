...
<form method="POST"  enctype="multipart/form-data" action="abtplace.php">
    <div class="fheader">
       ...
       // echo $vid;
                    ...
                    $sql9="select * from festivals  where festid ='$vid'";
                    //echo"<br>$no";
                    ...
                    if(mysqli_num_rows($result)>0)
                            {
                                while($row = mysqli_fetch_array($result))
                                {
                                    ...
                                    echo "<b style='margin-left:22%;font-size:28px'>$n </b> <br>"; 
                            ?>
                                    <br>
                                   <img src=" <?php  echo $row['image'] ;?>"  height ="400px" width=450px alt="" style="margin-left:20%">
                                   <br>
                                     ...
                                     ?>
                                     <br><br>
                                     <u> <b style="margin-left:20%;color:black;font-size:26px">Discription</b> </u> <br>
                                     <br>
                                           
                                   <?php
                                     echo " <div class='m' style='margin-left:9%'><span style='font-size:24px;margin-left:25%'> $abt</span></div>";  
 ...
 <br> <br>
   <!-- <a href='viewphoto.php?io= <?php //echo $row['festid'];?>'  style='color:black ;margin-left:39%;font-size:22px'>View Photo</a>
    <a href='comment.php?co= <?php// echo $row['festid'];?>'  style='color:black ;margin-left:5%;font-size:22px'>Comments of this place</a>-->
   <br><br>
