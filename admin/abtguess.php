...
<form method="POST"  enctype="multipart/form-data" action="abtplace.php">
    <div class="fheader">
                   ...
                   <?php
					...
					<ul>
							<li style="margin-left:20px;font-size:16px">  <a href="home.php" >HOME</a></li>
                            	<li> <a href="#">GUEST HOUSE-INFO</a>   <!--<ul>
       ...
       // echo $vid;
                    ...
                    $sql9="select * from guesshouse  where  guessid ='$vid'";
                    //echo"<br>$no";
 ...
 <br> <br>
   <!-- <a href='guessphoto.php?io= <?php //echo $row['guessid'];?>'  style='color:black ;margin-left:39%;font-size:22px'>View Photo</a>-->
    <a href='guescomment.php?co= <?php echo $row['name'];?>'  style='color:black ;margin-left:83%;font-size:22px' > See Review</a>
   <br><br>
