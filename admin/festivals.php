...
<form method="POST"  enctype="multipart/form-data" action="abtplace.php">
		       ...
		       <img src="photo/logo.jpg" height= "50px" width="250px" style=" margin-left:20px;">
                   ...
                   <div class="menubar">
							...
							<li>  <a href="home.php">HOME</a></li>
										<li> <a href="home.php">FESTIVALS</a>  </li> <!-- <ul>
							...
							&nbsp; <input type="text " style="width:230px;height:30px;margin-top:15px;margin-left:50%; border:none; outline:none;border-bottom: 1px solid black;">
  ...
  {
		$sql9="select * from festivals limit $start_from,$num_per_page";
		//echo"<br>$no";
		$result=mysqli_query($conn,$sql9);
		if(mysqli_num_rows($result)>0)
				{
					while($row = mysqli_fetch_array($result))
					{
						...
						echo "  <br> <b style='margin-left:60%;font-size:28px'>$n </b>"; 
				?>
						<br><br>
				...
				if(mysqli_num_rows($result)>0)
						{
							while($row = mysqli_fetch_array($result))
							{
								...
								//$i=$row['placeid'];
								//$v=$i;
								echo "  <br> <br> <br><br><br><br><br><br><br><br>  <br> <b style='font-size:22px; margin-bottom:100px' >  It usually celebrated by the  <span style='color:brown'>$belong </span > people</b>"; 
								echo"<br> <br> <b style='font-size:22px;margin-bottom:100px'>  in the month of   <span style='color:'> $m .</span>  </b>" ;?>
							      <a href='abtfest.php?iv= <?php echo $row['festid'];?>'  style='color:black'> Read more</a>  
 ...
 echo"<center>";
  ...
  $pr_query="select * from festivals";
 ...
 if($page>1)
 {
	...
	echo "<a href='festivals.php?page=" .($page-1) . " ' style='font-size:22px'> Previous </a> ";
...
for($i=1;$i<$total_page;$i++)
{
	...
	echo  "<a href='festivals.php?page=" . $i . " ' style='font-size:22px'> $i </a>";


}
if($i>$page)
{
   echo " <a href='festivals.php?page=" .($page+1) . " ' style='font-size:22px'> Next </a> ";
