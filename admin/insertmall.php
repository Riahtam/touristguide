...
<a href="mallcombine.php" style="margin-left:85%">BACK</a>     &nbsp; &nbsp;   <a href="dashboard.php">HOME</a>
<strong ><i    style="margin-left:20%;font-size:22px"><u >Mall Name</u></i></strong><br><br>
<input type="text" name="nam" id="nam" placeholder="Enter Mall Name"   required ><br><br>
...
if(isset($_POST['sub']))
   {
					...
					$sql1="select   *  from  mall  where name='$pname' ";
					...
					if($row==1){
						echo '<script type="text/javascript"> alert (" Data already exist..") </script>';
						...
						else
							{
								...
								$sql1="insert into mall values ('$pname','$local','$dist','','',NULL,'$about','$destina'); ";
								$result = mysqli_query($conn, $sql1);
