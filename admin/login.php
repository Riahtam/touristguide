    ...
    <div class="fheader">
        ...
        <div class="top">
		   <b  style="margin-left:60px;">HOME</b> &nbsp; &nbsp; <img src="photo/home.png" height= "20px"> 
		       ...
		       <b style="margin-left:50%;font-size:20px;">Toll number : 123-456789    &nbsp;  <a href="adminlog.php" style="margin-left:30px;color:white">Admin login </a>  <b>/</b> <a href="createacc.php" style="color:white">sign up</a> </b>
		...
		<form method="POST">
		<strong ><i    style="margin-left:40%;font-size:22px;color:white;"><u >Login</u></i></strong><br><br> 
