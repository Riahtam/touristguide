...
<form method="POST"  enctype="multipart/form-data" action="abtplace.php">
                   ...
                   <?php
					...
					<ul>
							<li style="margin-left:20px;font-size:16px">  <a href="home.php" >HOME</a></li>
                            	<li> <a href="#">RESTAURANT-INFO</a>   <!--<ul>
                    ...
                    if(mysqli_num_rows($result)>0)
                            ...
                            ?>
                                   ...
                                   <br> <br>
                                     ...
                                     ?>
                                     <br><br>
                                     <u> <b style="margin-left:30%;color:black;font-size:26px">Discription</b> </u> <br>
                                   <?php
 ...
 <br> <br>
   <!-- <a href='restphoto.php?io= <?php echo $row['id'];?>'  style='color:black ;margin-left:39%;font-size:22px'>View Photo</a>-->
    <a href='restcom.php?co= <?php echo $row['name'];?>'  style='color:black ;margin-left:80%;font-size:22px'>See Review</a>
   <br><br>
