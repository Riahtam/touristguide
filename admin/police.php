        ...
        <?php
					...
					if(isset($_POST['go']))
					{
						$dist=$_POST["type"];
							...
							$sql9="select * from emergency where district='$dist' and type='police' ";
							//echo"<br>$no";
						...
						echo"  <br> <br>  <center><span style='color : blue;font-size:22px'>For Emergency You can Contact 100. </span></center>";
						 echo"</center>";
						}
